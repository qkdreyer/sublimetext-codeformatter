...
class Log_file extends Log
{
    ...
    function log($message, $priority = null)
    {
        ...
        $path = CODEFORMATTER_LIBPATH.'beautifier.log';
        $success = file_put_contents($path, $line, FILE_APPEND);
        return $success;
        ...
        file_put_contents(CODEFORMATTER_LIBPATH.'phpbeautifier2.log', $line, FILE_APPEND);
